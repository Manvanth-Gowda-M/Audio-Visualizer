...
const STEPS = [
  ...
  { n: 2, icon: '🎨', label: 'Style',    sub: 'Style' },
  { n: 3, icon: '⬇️', label: 'Export',   sub: 'Render' },
]
        ...
        <div style={{ display: 'flex', gap: 4, flex: 1, overflowX: 'auto' }} className="lg:hidden">
          {STEPS.map((s) => {
            ...
            return (
              <button
                key={s.n}
                onClick={() => done && setCurrentStep(s.n as 1|2|3)}
          ...
          <div style={{
            ...
            <div style={{ marginBottom: 28, paddingBottom: 22, borderBottom: '1px solid rgba(255,255,255,0.07)' }}>
              <h1 style={{
                ...
                {currentStep === 2 && '2. Pick Style'}
                {currentStep === 3 && '3. Export'}
              </h1>
              <p style={{
                ...
                {currentStep === 2 && 'Pick a template, accent color, and typography style'}
                {currentStep === 3 && 'Your video is being rendered — this takes 1–3 minutes'}
              </p>
            </div>
            ...
            <div key={currentStep} className="animate-fade-in">
              ...
              {currentStep === 2 && <Step3Customize />}
              {currentStep === 3 && <Step4Export />}
            </div>
          </div>
        </div>
      </main>
