...
const TEMPLATES = [
  // Newest & Luxury/Premium templates first
  { id: 'geometric_vinyl',   name: 'Geometric Vinyl',    tag: '✦ Premium', desc: 'Minimalist vector U-shaped waveform with retro gradient', accent: '#f59e0b' },
  { id: 'romantic_tabletop', name: 'Romantic Tabletop',  tag: '✦ Luxury',  desc: 'Photorealistic candlelit dinner with glowing acrylic music player', accent: '#fb923c' },
  { id: 'vintage_scrapbook', name: 'Vintage Scrapbook',  tag: '✦ Premium', desc: 'Handmade retro indie diary with vinyl, cassettes, and paper cutouts', accent: '#d4c5b9' },
  { id: 'golden_floral',     name: 'Golden Floral',      tag: '✦ Luxury',  desc: 'Cinematic golden hour celebrity collage with soft floral depth', accent: '#fbbf24' },
  { id: 'dreamy_collage',    name: 'Dreamy Collage',     tag: '✦ Premium', desc: 'Soft pastel Pinterest aesthetic with scrapbook layers and frosted glass player', accent: '#bae6fd' },
  { id: 'sunlight_diary',    name: 'Sunlight Diary',     tag: '✦ Premium', desc: 'Warm aesthetic scrapbook collage with phone frame and sunflowers', accent: '#eab308' },
